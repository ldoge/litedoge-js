...
exports.verifyPOS = function verifyPOS(block) {
  ...
  if (txs[0].vout.length !== 1 || !txs[0].vout[0].isEmpty())
    return false;

  // Second transaction must be coinstake, the rest must not be
  if (txs.empty() || !txs[1].isCoinStake())
    return false;

  for (let i = 2; i < txs.length; i++) {
    if (txs[i].isCoinStake())
      return false;
  }
}
...
exports.getProofOfWorkReward = function getProofOfWorkReward(height) {
  ...
  if(height < 30)
  {
    return 1000 * exports.COIN;
  }
  else if(height < 1000)
  {
    return 1000000 * exports.COIN;
  }
  else if(height < 2000)
  {
    return 500000 * exports.COIN;
  }
  else if(height < 3000)
  {
    return 250000 * exports.COIN;
  }
  else if(height < 4000)
  {
    return 125000 * exports.COIN;
  }
  else if(height < 5000)
  {
    return 62500 * exports.COIN;
  }
  else if(height < 6000)
  {
    return 31250 * exports.COIN;
  }
  else if(height < 7000)
  {
    return 15625 * exports.COIN;
  }
  else if(height <= 8000)
  {
...
exports.getProofOfStakeReward = function getProofOfStakeReward(height) {
  ...
  if(height < 10000)
  {
    return 100000 * exports.COIN;
  }
  else if(height < 20000)
  {
    return 50000 * exports.COIN;
  }
  else if(height < 30000)
  {
    return 25000 * exports.COIN;
  }
  else if(height < 40000)
  {
    return 12500 * exports.COIN;
  }
  else if(height < 51000)
  {
    let nSubsidy = 10000 * exports.COIN;
    ...
    nSubsidy -= nSubsidy*(height % exports.REWARD_HALVING_PERIOD)/(2*exports.REWARD_HALVING_PERIOD);
    return nSubsidy;
  }
  else if(height < 144999)
  {
    return 30000 * exports.COIN;
  }
  else if(height < 189999)
  {
    return 28000 * exports.COIN;
  }
  else if(height < 234999)
  {
    return 26000 * exports.COIN;
  }
  else if(height < 279999)
  {
    return 24000 * exports.COIN;
  }
  else if(height < 324999)
  {
    return 22000 * exports.COIN;
  }
  else if(height < 369999)
  {
    return 20000 * exports.COIN;
  }
  else if(height < 414999)
  {
    return 18000 * exports.COIN;
  }
  else if(height < 459999)
  {
    return 16000 * exports.COIN;
  }
  else if(height < 504999)
  {
    return 14000 * exports.COIN;
  }
  else if(height < 549999)
  {
    return 12000 * exports.COIN;
  }
  ...
  {
    return 4000 * exports.COIN;
  }
  else if(height < 684999)
  {
    return 2000 * exports.COIN;
  }
