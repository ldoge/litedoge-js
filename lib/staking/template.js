...
class BlockTemplate {
  ...
  createCoinbase() {
    ...
    output.value = this.getProofOfStakeReward();
    ...
    //   CB size = 125
    //   Sigops cost = 4
    assert.strictEqual(cb.getWeight() + padding, 129);
    assert.strictEqual(cb.getBaseSize() + padding, 129);
    assert.strictEqual(cb.getSize() + padding, 129);
