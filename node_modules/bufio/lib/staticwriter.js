...
class StaticWriter {
  ...
  writeU8BI(value) {
    this.check(1);
    this.offset = encoding.writeU8BI(this.data, value, this.offset);
    return this;
  }
  ...
  writeU16BI(value) {
    this.check(2);
    this.offset = encoding.writeU16BI(this.data, value, this.offset);
    return this;
  }
  ...
  writeU16BEBI(value) {
    this.check(2);
    this.offset = encoding.writeU16BEBI(this.data, value, this.offset);
    return this;
  }
  ...
  writeU24BI(value) {
    this.check(3);
    this.offset = encoding.writeU24BI(this.data, value, this.offset);
    return this;
  }
  ...
  writeU24BEBI(value) {
    this.check(3);
    this.offset = encoding.writeU24BEBI(this.data, value, this.offset);
    return this;
  }
  ...
  writeU32BI(value) {
    this.check(4);
    this.offset = encoding.writeU32BI(this.data, value, this.offset);
    return this;
  }
  ...
  writeU32BEBI(value) {
    this.check(4);
    this.offset = encoding.writeU32BEBI(this.data, value, this.offset);
    return this;
  }
  ...
  writeU40BI(value) {
    this.check(5);
    this.offset = encoding.writeU40BI(this.data, value, this.offset);
    return this;
  }
  ...
  writeU40BEBI(value) {
    this.check(5);
    this.offset = encoding.writeU40BEBI(this.data, value, this.offset);
    return this;
  }
  ...
  writeU48BI(value) {
    this.check(6);
    this.offset = encoding.writeU48BI(this.data, value, this.offset);
    return this;
  }
  ...
  writeU48BEBI(value) {
    this.check(6);
    this.offset = encoding.writeU48BEBI(this.data, value, this.offset);
    return this;
  }
  ...
  writeU56BI(value) {
    this.check(7);
    this.offset = encoding.writeU56BI(this.data, value, this.offset);
    return this;
  }
  ...
  writeU56BEBI(value) {
    this.check(7);
    this.offset = encoding.writeU56BEBI(this.data, value, this.offset);
    return this;
  }
  ...
  writeU64BI(value) {
    this.check(8);
    this.offset = encoding.writeU64BI(this.data, value, this.offset);
    return this;
  }
  ...
  writeU64BEBI(value) {
    this.check(8);
    this.offset = encoding.writeU64BEBI(this.data, value, this.offset);
    return this;
  }
  ...
  writeI8BI(value) {
    this.check(1);
    this.offset = encoding.writeI8BI(this.data, value, this.offset);
    return this;
  }
  ...
  writeI16BI(value) {
    this.check(2);
    this.offset = encoding.writeI16BI(this.data, value, this.offset);
    return this;
  }
  ...
  writeI16BEBI(value) {
    this.check(2);
    this.offset = encoding.writeI16BEBI(this.data, value, this.offset);
    return this;
  }
  ...
  writeI24BI(value) {
    this.check(3);
    this.offset = encoding.writeI24BI(this.data, value, this.offset);
    return this;
  }
  ...
  writeI24BEBI(value) {
    this.check(3);
    this.offset = encoding.writeI24BEBI(this.data, value, this.offset);
    return this;
  }
  ...
  writeI32BI(value) {
    this.check(4);
    this.offset = encoding.writeI32BI(this.data, value, this.offset);
    return this;
  }
  ...
  writeI32BEBI(value) {
    this.check(4);
    this.offset = encoding.writeI32BEBI(this.data, value, this.offset);
    return this;
  }
  ...
  writeI40BI(value) {
    this.check(5);
    this.offset = encoding.writeI40BI(this.data, value, this.offset);
    return this;
  }
  ...
  writeI40BEBI(value) {
    this.check(5);
    this.offset = encoding.writeI40BEBI(this.data, value, this.offset);
    return this;
  }
  ...
  writeI48BI(value) {
    this.check(6);
    this.offset = encoding.writeI48BI(this.data, value, this.offset);
    return this;
  }
  ...
  writeI48BEBI(value) {
    this.check(6);
    this.offset = encoding.writeI48BEBI(this.data, value, this.offset);
    return this;
  }
  ...
  writeI56BI(value) {
    this.check(7);
    this.offset = encoding.writeI56BI(this.data, value, this.offset);
    return this;
  }
  ...
  writeI56BEBI(value) {
    this.check(7);
    this.offset = encoding.writeI56BEBI(this.data, value, this.offset);
    return this;
  }
  ...
  writeI64BI(value) {
    this.check(8);
    this.offset = encoding.writeI64BI(this.data, value, this.offset);
    return this;
  }
  ...
  writeI64BEBI(value) {
    this.check(8);
    this.offset = encoding.writeI64BEBI(this.data, value, this.offset);
    return this;
  }
  ...
  writeVarintBI(value) {
    this.offset = encoding.writeVarintBI(this.data, value, this.offset);
    return this;
  }
