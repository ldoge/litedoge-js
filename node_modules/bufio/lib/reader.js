...
class BufferReader {
  ...
  readU8BI() {
    this.check(1);
    const ret = BigInt(this.data[this.offset]);
    this.offset += 1;
    return ret;
  }
  ...
  readU16BI() {
    this.check(2);
    const ret = encoding.readU16BI(this.data, this.offset);
    this.offset += 2;
    return ret;
  }
  ...
  readU16BEBI() {
    this.check(2);
    const ret = encoding.readU16BEBI(this.data, this.offset);
    this.offset += 2;
    return ret;
  }
  ...
  readU24BI() {
    this.check(3);
    const ret = encoding.readU24BI(this.data, this.offset);
    this.offset += 3;
    return ret;
  }
  ...
  readU24BEBI() {
    this.check(3);
    const ret = encoding.readU24BEBI(this.data, this.offset);
    this.offset += 3;
    return ret;
  }
  ...
  readU32BI() {
    this.check(4);
    const ret = encoding.readU32BI(this.data, this.offset);
    this.offset += 4;
    return ret;
  }
  ...
  readU32BEBI() {
    this.check(4);
    const ret = encoding.readU32BEBI(this.data, this.offset);
    this.offset += 4;
    return ret;
  }
  ...
  readU40BI() {
    this.check(5);
    const ret = encoding.readU40BI(this.data, this.offset);
    this.offset += 5;
    return ret;
  }
  ...
  readU40BEBI() {
    this.check(5);
    const ret = encoding.readU40BEBI(this.data, this.offset);
    this.offset += 5;
    return ret;
  }
  ...
  readU48BI() {
    this.check(6);
    const ret = encoding.readU48BI(this.data, this.offset);
    this.offset += 6;
    return ret;
  }
  ...
  /**
   * Read uint48be BigInt.
   * @returns {BigInt}
   */

  readU48BE() {
    this.check(6);
    const ret = encoding.readU48BEBI(this.data, this.offset);
    this.offset += 6;
    return ret;
  }
  ...
  readU56BI() {
    this.check(7);
    const ret = encoding.readU56BI(this.data, this.offset);
    this.offset += 7;
    return ret;
  }
  ...
  readU56BEBI() {
    this.check(7);
    const ret = encoding.readU56BEBI(this.data, this.offset);
    this.offset += 7;
    return ret;
  }
  ...
  readU64BI() {
    this.check(8);
    const ret = encoding.readU64BI(this.data, this.offset);
    this.offset += 8;
    return ret;
  }
  ...
  readU64BEBI() {
    this.check(8);
    const ret = encoding.readU64BEBI(this.data, this.offset);
    this.offset += 8;
    return ret;
  }
  ...
  readI8BI() {
    this.check(1);
    const ret = encoding.readI8BI(this.data, this.offset);
    this.offset += 1;
    return ret;
  }
  ...
  readI16BI() {
    this.check(2);
    const ret = encoding.readI16BI(this.data, this.offset);
    this.offset += 2;
    return ret;
  }
  ...
  readI16BEBI() {
    this.check(2);
    const ret = encoding.readI16BEBI(this.data, this.offset);
    this.offset += 2;
    return ret;
  }
  ...
  readI24BI() {
    this.check(3);
    const ret = encoding.readI24BI(this.data, this.offset);
    this.offset += 3;
    return ret;
  }
  ...
  readI24BEBI() {
    this.check(3);
    const ret = encoding.readI24BEBI(this.data, this.offset);
    this.offset += 3;
    return ret;
  }
  ...
  readI32BI() {
    this.check(4);
    const ret = encoding.readI32BI(this.data, this.offset);
    this.offset += 4;
    return ret;
  }
  /**
  ...
  readI32BEBI() {
    this.check(4);
    const ret = encoding.readI32BEBI(this.data, this.offset);
    this.offset += 4;
    return ret;
  }
  ...
  readI40BI() {
    this.check(5);
    const ret = encoding.readI40BI(this.data, this.offset);
    this.offset += 5;
    return ret;
  }
  ...
  readI40BEBI() {
    this.check(5);
    const ret = encoding.readI40BEBI(this.data, this.offset);
    this.offset += 5;
    return ret;
  }
  ...
  readI48BI() {
    this.check(6);
    const ret = encoding.readI48BI(this.data, this.offset);
    this.offset += 6;
    return ret;
  }
  ...
  readI48BEBI() {
    this.check(6);
    const ret = encoding.readI48BEBI(this.data, this.offset);
    this.offset += 6;
    return ret;
  }
  ...
  readI56BI() {
    this.check(7);
    const ret = encoding.readI56BI(this.data, this.offset);
    this.offset += 7;
    return ret;
  }
  ...
  readI56BEBI() {
    this.check(7);
    const ret = encoding.readI56BEBI(this.data, this.offset);
    this.offset += 7;
    return ret;
  }
  ...
  readI64BI() {
    this.check(8);
    const ret = encoding.readI64BI(this.data, this.offset);
    this.offset += 8;
    return ret;
  }
  ...
  readI64BEBI() {
    this.check(8);
    const ret = encoding.readI64BEBI(this.data, this.offset);
    this.offset += 8;
    return ret;
  }
  ...
  readVarintBI() {
    const {size, value} = encoding.readVarintBI(this.data, this.offset);
    this.offset += size;
    return value;
  }
