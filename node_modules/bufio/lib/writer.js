...
class BufferWriter {
    ...
    for (const op of this.ops) {
      switch (op.type) {
        ...
        case FILL:
          ...
          break;
        case U8BI:
          off = encoding.writeU8BI(data, op.value, off);
          break;
        case U16BI:
          off = encoding.writeU16BI(data, op.value, off);
          break;
        case U16BEBI:
          off = encoding.writeU16BEBI(data, op.value, off);
          break;
        case U24BI:
          off = encoding.writeU24BI(data, op.value, off);
          break;
        case U24BEBI:
          off = encoding.writeU24BEBI(data, op.value, off);
          break;
        case U32BI:
          off = encoding.writeU32BI(data, op.value, off);
          break;
        case U32BEBI:
          off = encoding.writeU32BEBI(data, op.value, off);
          break;
        case U40BI:
          off = encoding.writeU40BI(data, op.value, off);
          break;
        case U40BEBI:
          off = encoding.writeU40BEBI(data, op.value, off);
          break;
        case U48BI:
          off = encoding.writeU48BI(data, op.value, off);
          break;
        case U48BEBI:
          off = encoding.writeU48BEBI(data, op.value, off);
          break;
        case U56BI:
          off = encoding.writeU56BI(data, op.value, off);
          break;
        case U56BEBI:
          off = encoding.writeU56BEBI(data, op.value, off);
          break;
        case U64BI:
          off = encoding.writeU64BI(data, op.value, off);
          break;
        case U64BEBI:
          off = encoding.writeU64BEBI(data, op.value, off);
          break;
        case I8BI:
          off = encoding.writeI8BI(data, op.value, off);
          break;
        case I16BI:
          off = encoding.writeI16BI(data, op.value, off);
          break;
        case I16BEBI:
          off = encoding.writeI16BEBI(data, op.value, off);
          break;
        case I24BI:
          off = encoding.writeI24BI(data, op.value, off);
          break;
        case I24BEBI:
          off = encoding.writeI24BEBI(data, op.value, off);
          break;
        case I32BI:
          off = encoding.writeI32BI(data, op.value, off);
          break;
        case I32BEBI:
          off = encoding.writeI32BEBI(data, op.value, off);
          break;
        case I40BI:
          off = encoding.writeI40BI(data, op.value, off);
          break;
        case I40BEBI:
          off = encoding.writeI40BEBI(data, op.value, off);
          break;
        case I48BI:
          off = encoding.writeI48BI(data, op.value, off);
          break;
        case I48BEBI:
          off = encoding.writeI48BEBI(data, op.value, off);
          break;
        case I56BI:
          off = encoding.writeI56BI(data, op.value, off);
          break;
        case I56BEBI:
          off = encoding.writeI56BEBI(data, op.value, off);
          break;
        case I64BI:
          off = encoding.writeI64BI(data, op.value, off);
          break;
        case I64BEBI:
          off = encoding.writeI64BEBI(data, op.value, off);
          break;
        case VARINTBI:
          off = encoding.writeVarintBI(data,op.value, off);
          break;
        default:
  ...
  writeVarintBI(value) {
    this.offset += encoding.sizeVarintBI(value);
    this.ops.push(new NumberOp(VARINTBI, value));
    return this;
  }
  ...
  writeU8BI(value) {
    this.offset += 1;
    this.ops.push(new NumberOp(U8BI, value));
    return this;
  }
  ...
  writeU16BI(value) {
    this.offset += 2;
    this.ops.push(new NumberOp(U16BI, value));
    return this;
  }
  ...
  writeU16BEBI(value) {
    this.offset += 2;
    this.ops.push(new NumberOp(U16BEBI, value));
    return this;
  }
  ...
  writeU24BI(value) {
    this.offset += 3;
    this.ops.push(new NumberOp(U24BI, value));
    return this;
  }
  ...
  writeU24BEBI(value) {
    this.offset += 3;
    this.ops.push(new NumberOp(U24BEBI, value));
    return this;
  }
  ...
  writeU32(value) {
    this.offset += 4;
    this.ops.push(new NumberOp(U32BI, value));
    return this;
  }
  ...
  writeU32BEBI(value) {
    this.offset += 4;
    this.ops.push(new NumberOp(U32BEBI, value));
    return this;
  }
  ...
  writeU40BI(value) {
    this.offset += 5;
    this.ops.push(new NumberOp(U40BI, value));
    return this;
  }
  ...
  writeU40BEBI(value) {
    this.offset += 5;
    this.ops.push(new NumberOp(U40BEBI, value));
    return this;
  }
  ...
  writeU48BI(value) {
    this.offset += 6;
    this.ops.push(new NumberOp(U48BI, value));
    return this;
  }
  ...
  writeU48BEBI(value) {
    this.offset += 6;
    this.ops.push(new NumberOp(U48BEBI, value));
    return this;
  }
  ...
  writeU56BI(value) {
    this.offset += 7;
    this.ops.push(new NumberOp(U56BI, value));
    return this;
  }
  ...
  writeU56BEBI(value) {
    this.offset += 7;
    this.ops.push(new NumberOp(U56BEBI, value));
    return this;
  }
  ...
  writeU64BI(value) {
    this.offset += 8;
    this.ops.push(new NumberOp(U64BI, value));
    return this;
  }
  ...
  writeU64BEBI(value) {
    this.offset += 8;
    this.ops.push(new NumberOp(U64BEBI, value));
    return this;
  }
  ...
  writeI8BI(value) {
    this.offset += 1;
    this.ops.push(new NumberOp(I8BI, value));
    return this;
  }
  ...
  writeI16BI(value) {
    this.offset += 2;
    this.ops.push(new NumberOp(I16BI, value));
    return this;
  }
  ...
  writeI16BEBI(value) {
    this.offset += 2;
    this.ops.push(new NumberOp(I16BEBI, value));
    return this;
  }
  ...
  writeI24BI(value) {
    this.offset += 3;
    this.ops.push(new NumberOp(I24BI, value));
    return this;
  }
  ...
  writeI24BEBI(value) {
    this.offset += 3;
    this.ops.push(new NumberOp(I24BEBI, value));
    return this;
  }
  ...
  writeI32BI(value) {
    this.offset += 4;
    this.ops.push(new NumberOp(I32BI, value));
    return this;
  }
  ...
  writeI32BEBI(value) {
    this.offset += 4;
    this.ops.push(new NumberOp(I32BEBI, value));
    return this;
  }
  ...
  writeI40BI(value) {
    this.offset += 5;
    this.ops.push(new NumberOp(I40BI, value));
    return this;
  }
  ...
  writeI40BEBI(value) {
    this.offset += 5;
    this.ops.push(new NumberOp(I40BEBI, value));
    return this;
  }
  ...
  writeI48BI(value) {
    this.offset += 6;
    this.ops.push(new NumberOp(I48BI, value));
    return this;
  }
  ...
  writeI48BEBI(value) {
    this.offset += 6;
    this.ops.push(new NumberOp(I48BEBI, value));
    return this;
  }
  ...
  writeI56BI(value) {
    this.offset += 7;
    this.ops.push(new NumberOp(I56BI, value));
    return this;
  }
  ...
  writeI56BEBI(value) {
    this.offset += 7;
    this.ops.push(new NumberOp(I56BEBI, value));
    return this;
  }
  ...
  writeI64BI(value) {
    this.offset += 8;
    this.ops.push(new NumberOp(I64BI, value));
    return this;
  }
  ...
  writeI64BEBI(value) {
    this.offset += 8;
    this.ops.push(new NumberOp(I64BEBI, value));
    return this;
  }
